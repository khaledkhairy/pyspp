"""
Test script for Bunny mesh parameterization
Translated from MATLAB wbb_Bunny.m
"""
...
def main():
    print("=== Bunny Mesh Parameterization Test ===")
    tic = time.time()
    ...
    # Plot original mesh
    plot_mesh_pyvista(m, "Original Bunny Mesh")
